...
<head>
	...
	<title>G-mys | Medios de pago</title>
    ...
    <div class="d-none d-sm-none d-md-block col-md-7">
      <ul class="nav">
        <li class="nav-item" style="margin-right: 20px;">
            <a href="#"><button class="btn btn-sm btn-outline-info zoom" type="button">MEDIOS DE PAGO</button></a>
        </li>
        <li class="nav-item">
...
<center><h2 class="card-title" style="margin-top:12rem;">MEDIOS DE PAGO</h2></center>


<div class="card-group col-md-12 text-center container" style="margin-top:2rem;" >
  <div class="col-md-4">
    <div class="card-body">
      <h5 class="card-title">Electronico</h5>
      <a href="https://www.avalpaycenter.com/wps/portal/portal-de-pagos/web/banco-de-occidente/resultado-busqueda/realizar-pago?idConv=00001999&origen=buscar"><img src="img/pse.png" width="200" height="100"></a>
    </div>
  </div>
  <div class="col-md-4">
    <div class="card-body">
      <h5 class="card-title">Convenio</h5>
      <img src="img/efecty.png" width="200" height="100">
    </div>
  </div>
  <div class="col-md-4">
    <div class="card-body">
      <h5 class="card-title">Convenio</h5>
      <img src="img/banco.png" width="250" height="100">
    </div>
  </div>
</div>
  <div class="container-fluid" id="w1" style="margin-top: 3rem;">
    <center>
    <h5>Para saber el convenio, escribir al whatsapp</h5>
